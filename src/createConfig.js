  ...
  return {
    resolve: {
      ...
      alias: {
        ...
        // Home made fix
        './RNGestureHandlerModule': join(process.cwd(), 'node_modules', 'react-native-gesture-handler', 'RNGestureHandlerModule.web.js'),
        './GestureHandlerButton': join(process.cwd(), 'node_modules', 'react-native-gesture-handler', 'GestureHandlerButton.web.js'),
        './GestureComponents': join(process.cwd(), 'node_modules', 'react-native-gesture-handler', 'GestureComponents.web.js'),
        './PlatformConstants': join(process.cwd(), 'node_modules', 'react-native-gesture-handler', 'PlatformConstants.web.js'),
        './resolveAssetSource': join(process.cwd(), 'node_modules', 'expo-asset', 'build', 'resolveAssetSource.web.js'),
        './EmbeddedAssets': join(process.cwd(), 'node_modules', 'expo-asset', 'build', 'EmbeddedAssets.web.js'),
        './AssetSourceResolver': join(process.cwd(), 'node_modules', 'expo-asset', 'build', 'AssetSourceResolver.web.js'),
        './AssetRegistry': join(process.cwd(), 'node_modules', 'expo-asset', 'build', 'AssetRegistry.web.js'),
